...
#%%%%% 
#MH these lines have been modified
...
ifeq ($(shell [[ "$(GC_LIB)" =~ $(REGEXP) ]] && echo true),true) # CLMW - change to output as HDF5 
  ...
  NC_LINK_CMD        := -L$(GC_LIB) -lnetcdf -L$(GC_F_LIB) -lnetcdff -L$(GC_HDF5_LIB) -lhdf5_hl -lhdf5_fortran -lhdf5hl_fortran -lhdf5 -lsz -lz -DUSE_HDF5
    NCL                := -L$(GC_LIB) -lnetcdf -L$(GC_F_LIB) -lnetcdff -L$(GC_HDF5_LIB) -lhdf5_hl -lhdf5_fortran -lhdf5hl_fortran -lhdf5 -lsz -lz -DUSE_HDF5

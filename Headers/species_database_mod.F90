...
!                              RC            = RC )
          ...
          CASE( 'ISOA1', 'ISOA2', 'ISOA3' )
             FullName = 'Lumped semivolatile aerosol products of isoprene oxidation'
	     ...
	     ! Halve the Kc (cloud condensate -> precip) rate
          ...
          CASE( 'INDIOL' )
             ...
             CALL Spc_Create( am_I_Root     = am_I_Root,                    &
                              ...
                              ModelID       = N,                            &
                              Name          = NameAllCaps,                  &
                              FullName      = 'SOA from alkyl nitrates',    &
                              MW_g          = 102.0_fp,                     &
                              Is_Advected   = T,                            &
                              Is_Gas        = F,                            &
                              Is_Drydep     = T,                            &
          ...
          CASE( 'LVOCOA' )
             ...
             CALL Spc_Create( am_I_Root     = am_I_Root,                    &
                              ...
                              ModelID       = N,                            &
                              Name          = NameAllCaps,                  &
                              FullName      = 'SOA from ISOPOOH oxidation product',   &
                              MW_g          = 154.0_fp,                     &
                              Is_Advected   = T,                            &
                              Is_Gas        = F,                            &
                              Is_Drydep     = T,                            &
          ...
          CASE( 'SOAMG' )
             ...
             CALL Spc_Create( am_I_Root     = am_I_Root,                    &
                              ...
                              ModelID       = N,                            &
                              Name          = NameAllCaps,                  &
                              FullName      = 'SOA from Methylglyoxal',     &
                              MW_g          = 72.0_fp,                      &
                              Is_Advected   = T,                            &
                              Is_Gas        = F,                            &
                              Is_Drydep     = T,                            &
          ...
          CASE( 'SOAGC' )
             ...
             CALL Spc_Create( am_I_Root     = am_I_Root,                    &
                              ...
                              ModelID       = N,                            &
                              Name          = NameAllCaps,                  &
                              FullName      = 'SOA from GGlycoaldehyde',    &
                              MW_g          = 60.0_fp,                      &
                              Is_Advected   = T,                            &
                              Is_Gas        = F,                            &
                              Is_Drydep     = T,                            &
          ...
          CASE( 'GLYX' )
             CALL Spc_Create( am_I_Root     = am_I_Root,                    &
                              ...
                              DD_F0         = 1.0_fp,                       &
#if defined( NEW_HENRY_CONSTANTS )					    
                              Henry_K0      = 4.1e+3_f8 * To_M_atm,         &
			      Henry_CR      = 7500.0_f8                     &
#else									    
                              DD_Hstar_old  = 3.60e+5_fp,                   &
                              Henry_K0      = 3.60e+5_f8,                   &
                              Henry_CR      = 7200.0_f8,                    &
#endif									    
                              WD_RetFactor  = 2.0e-2_fp,                    &
          ...
          CASE( 'MGLY' )
             CALL Spc_Create( am_I_Root     = am_I_Root,                    &
                              ...
                              DD_F0         = 1.0_fp,                       &
#if defined( NEW_HENRY_CONSTANTS )					    
                              Henry_K0      = 3.2e+2_f8 * To_M_atm,         &
			      Henry_CR      = 5300.0_f8,                    &
#else									    
                              DD_Hstar_old  = 3.70e+3_fp,                   &
                              Henry_K0      = 3.70e+3_f8,                   &
                              Henry_CR      = 7500.0_f8,                    &
#endif									    
                              WD_RetFactor  = 2.0e-2_fp,                    &
...
!#endif		
          ...
          CASE( 'LVOC' )
             CALL Spc_Create( am_I_Root     = am_I_Root,                    &
                              ...
                              ModelID       = N,                            &
                              Name          = NameAllCaps,                  &
                              FullName      = 'ISOPOOH oxidation product',              &
                              MW_g          = 154.0_fp,                      &
                              Is_Advected   = T,                            &
                              Is_Gas        = T,                            &
                              Is_Drydep     = T,                            &
...
!#endif		
          ...
          CASE( 'ISN1OG' )
             CALL Spc_Create( am_I_Root     = am_I_Root,                    &
                              ...
                              ModelID       = N,                            &
                              Name          = NameAllCaps,                  &
                              FullName      = '2nd generation organic nitrates from Isoprene nitrate',           &
                              MW_g          = 226.0_fp,                     &
                              Is_Advected   = T,                            &
                              Is_Gas        = T,                            &
                              Is_Drydep     = T,                            &
...
!                              RC            = RC )
          ...
          CASE( 'IPMN' )
             CALL Spc_Create( am_I_Root     = am_I_Root,                    &
                              ...
                              ModelID       = N,                            &
                              Name          = NameAllCaps,                  &
                              FullName      = 'Isoprene Peroxymethacroyl nitrate',   &
                              MW_g          = 147.0_fp,                     &
                              Is_Advected   = T,                            &
                              Is_Gas        = T,                            &
                              Is_Drydep     = T,                            &
          ...
          CASE( 'NPMN' )
             CALL Spc_Create( am_I_Root     = am_I_Root,                    &
                              ...
                              ModelID       = N,                            &
                              Name          = NameAllCaps,                  &
                              FullName      = 'Non-Isoprene Peroxymethacroyl nitrate',   &
                              MW_g          = 147.0_fp,                     &
                              Is_Advected   = T,                            &
                              Is_Gas        = T,                            &
                              Is_Drydep     = T,                            &
